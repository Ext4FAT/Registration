...
public:
	...
	*/
	static Mat PXCImage2Mat(PXCImage* pxc);
	/**
	...
	*/
	static string getSavePath(const string dir,
		time_t slot,
		long framecnt);
	/**
	...
	*/
	static int savePCD(const string filename,
		PointSet &pSet,
	...
	*/
	static Rect myBoundBox(vector<PXCPointF32> &pointset);
